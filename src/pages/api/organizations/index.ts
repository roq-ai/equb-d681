...
async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  async function createOrganization() {
    ...
    const body = { ...req.body };
    if (body?.finance_sharing?.length > 0) {
      const create_finance_sharing = body.finance_sharing;
      body.finance_sharing = {
        create: create_finance_sharing,
      };
    } else {
      delete body.finance_sharing;
    }
