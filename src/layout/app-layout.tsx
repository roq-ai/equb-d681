...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'member'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    {
      name: 'Finance Sharing',
      path: '/finance-sharings',
      entity: 'finance_sharing',
      service: AccessServiceEnum.PROJECT,
      icon: FiDollarSign,
    },
    { name: 'Membership', path: '/memberships', entity: 'membership', service: AccessServiceEnum.PROJECT, icon: FiBox },
